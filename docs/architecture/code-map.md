...
| Eval-run provenance parsing and envelope validation | Planned: `openevalgate/provenance.py` | Planned: `tests/test_provenance.py`, `tests/test_provenance_fixtures.py` | Planned ownership for manifest discovery, schema validation, CSV identity cross-checks, digest checks, artifact index validation, and assurance classification. |
| Provenance freshness and release-context comparison | Planned: `openevalgate/provenance.py` | Planned: `tests/test_provenance_freshness.py` | Planned ownership for review-context comparison, stale evidence, recency, and provenance authorization inputs. |
