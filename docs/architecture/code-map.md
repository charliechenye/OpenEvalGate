...
| Eval-run provenance parsing and envelope validation | Planned: `openevalgate/provenance.py` | Contract fixtures: `tests/test_provenance_contract_fixtures.py`; planned runtime tests: `tests/test_provenance.py`, `tests/test_provenance_fixtures.py` | Contract-development validation covers schemas, fixture expectations, CSV identity cross-checks, digest checks, artifact index semantics, and assurance classification; runtime ownership remains planned. |
| Provenance freshness and release-context comparison | Planned: `openevalgate/provenance.py` | Contract fixtures: `tests/test_provenance_contract_fixtures.py`; planned runtime tests: `tests/test_provenance_freshness.py` | Contract-development validation covers review-context comparison, stale evidence, recency, and expected authorization classifications; runtime ownership remains planned. |
