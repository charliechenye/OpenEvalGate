...
1. Classify verified assurance, freshness, recency, and complete contract authorization.
2. Parse and enforce `review_context.yaml` for current-release comparison.
3. Extend report output beyond runtime identity and lifecycle status.
